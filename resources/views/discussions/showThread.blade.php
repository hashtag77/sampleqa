    ...
    <div class="card-body">
      <div class="row">
        <div class="col-md-1" style="padding-left: 25px;">
          <img src="{{ url('/storage/avatars/'.$user->avatar) }}" style="width: 45px; height: 45px; border-radius: 25px">
        </div>
        <div class="col-md-9">
        ...
        @foreach($comments as $comment)
          <div style="{{ $comment->helpful == 1 ? "background-color: #e1eaea; border: 1px solid #666666; border-radius: 10px;" : "" }}">
            <div class="row" style="padding: 10px 10px; ">
                <div class="col-md-8">
                  <img src="{{ url('/storage/avatars/'.$comment->avatar) }}" style="width: 35px; height: 35px; border-radius: 25px">
